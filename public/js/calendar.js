...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var eventCancel = document.getElementById("eventCancel");
  var eventConfirm = document.getElementById("eventConfirm");
  ...
  function getEvents() {
    ...
    axiosInstance.get("mail/change/events/all").then(function (response) {
  ...
  eventConfirm.addEventListener("click", function () {
    ...
    axiosInstance.post("mail/change/events/update", JSON.stringify({
      id: userID,
      title: title,
      date: date,
      time: time
